...
const SignIn: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const checkoutSchema = yup.object().shape({
    id: yup.string().required("obligatoire!"),
    mdp: yup.string().required("obligatoire!"),
  });
  ...
  return (
    <div
      ...
      <Box className="b1 ">
        <p className="font-Poppins text-6xl font-bold text-white  ">
          SE CONNECTER A KKT
        </p>
        <Formik
          ...
          {({
            ...
            <form onSubmit={handleSubmit}>
              <Box className="mb-4 space-y-8 ">
                <div className="mb-6 space-y-4">
                  <label className="mb-2.5 block font-bold text-white ">
                    Carte d'identité
                  </label>
                ...
                <div className="mb-6 space-y-4">
                  ...
                  <div className="relative">
                    ...
                    {touched.mdp && errors.mdp && (
                      <div className="absolute text-red-600	">{errors.mdp}</div>
                    )}
                  </div>
                </div>
                <Box className="mb-4">
